 ...
 * @author USER
 */
public class Dev6Login extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Dev6Login.class.getName());

    /**
     * Creates new form Dev6Login
     */
    public Dev6Login() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Dev 6 Login Form");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Dev6Login().setVisible(true));
    }
