 ...
 * @author DELL
 */
public class Dev4profile extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Dev4profile.class.getName());

    /**
     * Creates new form Dev4profile
     */
    public Dev4profile() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HRMS PROFILE FROM");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Dev4profile().setVisible(true));
    }
